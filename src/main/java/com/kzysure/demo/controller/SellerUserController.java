...
public class SellerUserController {
  ...
  public ModelAndView login(@RequestParam("openid") String openid,Map<String,String> map,HttpServletResponse httpServletResponse){
    ...
    map.put("token","\""+token+"\"");
    map.put("url","\"http://localhost:4200/data-v/github\"");
    map.put("msg","GitHub单点登录成功");
    return new ModelAndView("common/githubsuccess",map);
//    return new ModelAndView("redict:localhost:4200");
  }
  @GetMapping("/logout")
